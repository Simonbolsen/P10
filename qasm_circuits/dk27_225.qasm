...
gate mcu1_140196053526624(param0) q0,q1,q2,q3,q4,q5 { cu1(pi/16) q4,q5; cx q4,q3; cu1(-pi/16) q3,q5; cx q4,q3; cu1(pi/16) q3,q5; cx q3,q2; cu1(-pi/16) q2,q5; cx q4,q2; cu1(pi/16) q2,q5; cx q3,q2; cu1(-pi/16) q2,q5; cx q4,q2; cu1(pi/16) q2,q5; cx q2,q1; cu1(-pi/16) q1,q5; cx q4,q1; cu1(pi/16) q1,q5; cx q3,q1; cu1(-pi/16) q1,q5; cx q4,q1; cu1(pi/16) q1,q5; cx q2,q1; cu1(-pi/16) q1,q5; cx q4,q1; cu1(pi/16) q1,q5; cx q3,q1; cu1(-pi/16) q1,q5; cx q4,q1; cu1(pi/16) q1,q5; cx q1,q0; cu1(-pi/16) q0,q5; cx q4,q0; cu1(pi/16) q0,q5; cx q3,q0; cu1(-pi/16) q0,q5; cx q4,q0; cu1(pi/16) q0,q5; cx q2,q0; cu1(-pi/16) q0,q5; cx q4,q0; cu1(pi/16) q0,q5; cx q3,q0; cu1(-pi/16) q0,q5; cx q4,q0; cu1(pi/16) q0,q5; cx q1,q0; cu1(-pi/16) q0,q5; cx q4,q0; cu1(pi/16) q0,q5; cx q3,q0; cu1(-pi/16) q0,q5; cx q4,q0; cu1(pi/16) q0,q5; cx q2,q0; cu1(-pi/16) q0,q5; cx q4,q0; cu1(pi/16) q0,q5; cx q3,q0; cu1(-pi/16) q0,q5; cx q4,q0; cu1(pi/16) q0,q5; }
gate mcx_gray_140194995498352 q0,q1,q2,q3,q4,q5 { h q5; mcu1_140196053526624(pi) q0,q1,q2,q3,q4,q5; h q5; }
qreg f8[1];
qreg f7[1];
qreg f6[1];
qreg f5[1];
...
ccx x2[0],x4[0],f0[0];
x x2[0];
mcx x2[0],x4[0],x7[0],f0[0];
mcx x2[0],x4[0],x7[0],f1[0];
x x0[0];
x x1[0];
x x5[0];
mcx_gray x0[0],x1[0],x2[0],x4[0],x5[0],x7[0],f2[0];
mcx_gray x0[0],x1[0],x2[0],x4[0],x5[0],x7[0],f7[0];
x x7[0];
x x6[0];
mcx_gray x1[0],x2[0],x4[0],x5[0],x6[0],x7[0],f2[0];
x x3[0];
mcx_gray_140194995498352 x0[0],x2[0],x3[0],x4[0],x7[0],f4[0];
